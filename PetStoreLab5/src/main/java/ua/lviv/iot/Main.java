...
public class Main {
    ...
    public static void main(final String[] args) {
        ...
        while (menu) {
            ...
            System.out.println(" 4 - Print list of pets "
                    + "sorted by number of food;");
            ...
            switch (num) {
                ...
                case 2:
                    ...
                    //scanner.close();
                    if (type.equals("Mammals") || type.equals("MAMMALS")
                            || type.equals("mammals")) {
                        System.out.println(
                                store.searchPetByTypeSortedByFoodType(
                                        Types.MAMMALS).toString());
                    } else if (type.equals("Birds") || type.equals("BIRDS")
                            || type.equals("birds")) {
                        System.out.println(
                                store.searchPetByTypeSortedByFoodType(
                                        Types.BIRDS).toString());
                    } else if (type.equals(
                            "AMPHIBIANS") || type.equals("Amphibians")
                            || type.equals("amphibians")) {
                        System.out.println(store.searchPetByTypeSortedByFoodType(Types.AMPHIBIANS).toString());
                    } else if (type.equals("REPTILES")
                            || type.equals("Reptiles")
                            || type.equals("reptiles")) {
                        ...
                        System.out.println(store
                                .searchPetByTypeSortedByFoodType(Types.FISH).toString());
                    } else if (type.equals("Insects") || type.equals("INSECTS")
                            || type.equals("insects")) {
                        System.out.println(store.searchPetByTypeSortedByFoodType(Types.INSECTS).toString());
                    } else if (type.equals("CRUSTACEANS")
                            || type.equals("Crustaceans")
                            || type.equals("crustaceans")) {
                        System.out.println(store
                                .searchPetByTypeSortedByFoodType(Types.CRUSTACEANS).toString());
                    } else if (type.equals("MOLLUSKS")
                            || type.equals("Mollusks")
                            || type.equals("mollusks")) {
                        System.out.println(store.searchPetByTypeSortedByFoodType(Types.MOLLUSKS).toString());
                    } else if (type.equals("SPIDERSHAPED")
                            || type.equals("Spidershaped")
                            || type.equals("spidershaped")) {
